...
// Trial-nudge milestone selection + email copy live in a dependency-free
// module so the unit tests can require them without functions/node_modules.
const { pickTrialMilestone, trialEmailContent } = require("./trial-nudge-content");
