/**
 * CJS COPY of js/services/category-service.js for Cloud Functions.
 ...
 * edit js/services/category-service.js and run `npm run sync:shared`.
 ...
 * @returns {string|null}
 */
function normalizeCategoryKey(input, source) {
 ...
 */
function getAllExpenseCategories(source) {
...
function getCategoryLabel(key, source) {
    const all = source ? getAllExpenseCategories(source) : EXPENSE_CATEGORIES;
    return (all[key] || all['other']).label;
}

function getCategoryColor(key, source) {
    const all = source ? getAllExpenseCategories(source) : EXPENSE_CATEGORIES;
 ...
 */
function getCategoryOptionList(source) {
...
module.exports = { normalizeCategoryKey, getCategoryGroups, getAllExpenseCategories, getCategoryLabel, getCategoryColor, getCategoryOptionList, EXPENSE_CATEGORIES };
