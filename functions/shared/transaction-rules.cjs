/**
 * CJS COPY of js/services/transaction-rules.js for Cloud Functions.
 ...
 * edit js/services/transaction-rules.js and run `npm run sync:shared`.
...
function matchesCondition(m, expense) {
...
function matchesRule(rule, expense) {
...
function applyActions(actions, expense) {
 ...
 */
function applyRulesToExpense(rules, expense) {
 ...
 */
function applyRulesToExpenses(rules, expenses) {
...
module.exports = { normalizeMatch, matchesCondition, matchesRule, applyActions, applyRulesToExpense, applyRulesToExpenses, validateRule };
