 ...
 */
function billTotalForMonth(bills, year, month, payDatesInMonth = [], opts = {}) {
 ...
 */
function billOccurrenceDatesForMonth(bill, year, month, payDatesInMonth = [], { fallbackPayChecks = 2 } = {}) {
 ...
 */
function reconciledBillSpendForMonth(bills, year, month, payDatesInMonth, monthExpenses, opts = {}) {
