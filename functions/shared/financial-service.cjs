 ...
 * edit js/services/financial-service.js and run `npm run sync:shared`.
 ...
 */
function billTotalForMonth(bills, year, month, payDatesInMonth = [], { fallbackPayChecks = 2 } = {}) {
