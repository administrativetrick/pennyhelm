...
import { GOAL_CATEGORIES, getGoalCategoryInfo } from '../services/goal-categories.js';
import { generateCsvExport, generatePdfReport } from '../services/report-export.js';
...
function buildHealthScoreHtml(ctx) {
    ...
    // the real payment (caught by redacted on 2026-04-19, where a
