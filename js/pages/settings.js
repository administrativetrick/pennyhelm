                ...
                openModal('Create API Key', `
                    <div style="padding:8px 0 16px;font-size:14px;">
                        ...
                        <label style="display:flex;align-items:flex-start;gap:8px;cursor:pointer;font-size:13px;">
                            ...
                            <span style="color:var(--text-muted);font-size:12px;">Lets integrations add, edit, and delete expenses, bills, budgets, debts, and rules &mdash; not just read.</span></span>
                        </label>
