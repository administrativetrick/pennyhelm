 ...
 */
export function classifyExpenseFlow(e) {
...
export function isTransferExpense(e) {
 ...
 */
export function effectiveExpenseCategory(e) {
 ...
 */
export function spendingExpenses(expenses) {
    return (expenses || [])
        .filter(e => e
            && !e.ignored
...
export function monthlyBillCommitment(bills) {
...
export function createFinancialSnapshot(data) {
    const now = new Date();
 ...
 */
export function monthlySpendingSeries(expenses, monthsBack = 12, now = new Date()) {
    const byMonth = {};
 ...
 * @returns {number}
 */
export function monthlyBillSpend(data, category, mKey, monthExpenses = []) {
